...
TARGET_DIR="/Users/sven/Documents/Projekte/quantified_sven"

# Name of daily stats file
DATA_FILE="/Users/sven/Documents/Projekte/quantified_sven/data/project-qs-stats.csv"
#
##################################
...
echo "Project QS Stats Analysis for ${CURRENTDATETIME}"
...
echo ${YESTERDAY}, ${CURRENTDATETIME}, $total_files, $files_changed, $files_added, $files_modified, $files_deleted, $files_renamed, $words_added, $words_deleted, $words_duplicated, $refs_added, $refs_deleted >> $DATA_FILE

# Commit Changes to Git with Custom Message
commit_msg=("$YESTERDAY Daily Project Stats: Words Added: $words_added, Files Added: $files_added")
echo $commit_msg
...
osascript -e 'display notification "Successfully copied project files and logged stats into git." with title "Yesterday Daily Project Stats Saved"'
