...
TARGET_DIR="$HOME/Library/CloudStorage/GoogleDrive-pr.giersig@gmail.com/Meine Ablage/PARA/2. Areas/Technik & Programmierung/quantified_sven/"

# Name of daily stats file
DATA_FILE="$HOME/Library/CloudStorage/GoogleDrive-pr.giersig@gmail.com/Meine Ablage/data/writing/track-code-qs.csv"
...
echo "Coding Stats Analysis for ${CURRENTDATETIME}"
...
commit_msg=("$YESTERDAY Daily Quantified Coding Stats: Words Added: $words_added, Files Added: $files_added")
echo $commit_msg
