...
echo "Blogging Stats Analysis for Giersig at ${CURRENTDATETIME}"
...
commit_msg=("$YESTERDAY Daily Blogging Stats for Giersig: Words Added: $words_added, Files Added: $files_added")
echo $commit_msg
