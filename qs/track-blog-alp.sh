...
TARGET_DIR="$HOME/Projekte/alptraum"

# Name of daily stats file
DATA_FILE="$HOME/Projekte/quantified_sven/data/track-blog-alp.csv"
#
##################################
...
echo "Blogging Stats Analysis for Alptraum at ${CURRENTDATETIME}"
...
commit_msg=("$YESTERDAY Daily Blogging Stats for Alptraum: Words Added: $words_added, Files Added: $files_added")
echo $commit_msg
...
#osascript -e 'display notification "Successfully copied writing files and logged stats into git." with title "Yesterday Blogging Stats for Alptraum Saved"'
