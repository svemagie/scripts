...
echo "Blogging Stats Analysis for Chibatsu at ${CURRENTDATETIME}"
...
commit_msg=("$YESTERDAY Daily Blogging Stats for Chibatsu: Words Added: $words_added, Files Added: $files_added")
echo $commit_msg
...
#osascript -e 'display notification "Successfully copied writing files and logged stats into git." with title "Yesterday Daily Blogging Stats for Chibatsu Saved"'
