...
#TARGET_DIR="$HOME/Library/Mobile Documents/iCloud~md~obsidian/Documents/Notes"
TARGET_DIR="$HOME/Memex"
...
commit_msg=("$YESTERDAY Daily Memex Writing Stats: Words Added: $words_added, Files Added: $files_added")
echo $commit_msg
...
osascript -e 'display notification "Successfully copied Memex writing files and logged stats into git." with title "Yesterday Daily Writing Stats Saved"'
